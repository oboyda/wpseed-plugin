    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-input date-from">
                ...
                <input type="text" class="date-input-display date-from-display" name="<?php echo $view->get_input_name_from(); ?>_display" autocomplete="off" />
                <input type="hidden" class="date-input date-from" name="<?php echo $view->get_input_name_from(); ?>" />
        ...
        <div class="col-lg-6">
            <div class="form-input date-till">
                ...
                <input type="text" class="date-input-display date-till-display" name="<?php echo $view->get_input_name_till(); ?>_display" autocomplete="off" />
                <input type="hidden" class="date-input date-till" name="<?php echo $view->get_input_name_till(); ?>" />
                <div class="datepicker d-none"></div>
            </div>
        </div>
    </div>
