...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Action_Email_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Action_Email/index.js */ "./mods/Action_Email/index.js");
/* harmony import */ var _Action_Email_index_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_Action_Email_index_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Status_Message_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Status_Message/index.js */ "./mods/Status_Message/index.js");
/* harmony import */ var _Status_Message_index_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_Status_Message_index_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _User_Login_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./User_Login/index.js */ "./mods/User_Login/index.js");
/* harmony import */ var _User_Login_index_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_User_Login_index_js__WEBPACK_IMPORTED_MODULE_2__);
...
jQuery(function ($) {
  ...
  */
  ...
  function loadView(parentView, viewName) {
    let viewArgs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    let viewArgsCast = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let cbk = arguments.length > 4 ? arguments[4] : undefined;
  ...
  $("form.ajax-form-std").each(function () {
    ...
    form.find(".view.form-files-drop").each(function () {
      ...
      if (dropArea.length && fileInput.length) {
        ...
        dropArea.on("drop", function (e) {
          ...
          const filesArr = Array.from(_e.dataTransfer.files); // Attach files to the input
    ...
    */
    ...
    form.find(".view.form-input-dates").each(function () {
      ...
      if (datepickerFromElem.length && !datepickerFromElem.hasClass("hasDatepicker") && // dateFromFieldDisplay.length && 
      ...
      typeof $.fn.datepicker !== "undefined") {
        ...
        if (datepickerTillElem.length) // if(dateTillFieldDisplay.length)
          {
            dateFromFieldAlt.on("change", function () {
              const minDate = new Date(this.value);
              datepickerTillElem.datepicker("option", "minDate", minDate); // dateTillFieldDisplay.datepicker("option", "minDate", minDate);
            });
          }
      }
      ...
      if (datepickerTillElem.length && !datepickerTillElem.hasClass("hasDatepicker") && // dateTillFieldDisplay.length && 
      ...
      typeof $.fn.datepicker !== "undefined") {
        ...
        if (datepickerFromElem.length) // if(dateFromFieldDisplay.length)
          {
            dateTillFieldAlt.on("change", function () {
              const maxDate = new Date(this.value);
              datepickerFromElem.datepicker("option", "maxDate", maxDate); // dateFromFieldDisplay.datepicker("option", "maxDate", maxDate);
            });
          }
      }
  ...
  */
  ...
  $(document.body).on("view_loaded_form-nice-dropdown", function (e, view) {
    ...
    function updateLabelText() {
      ...
      let hasSelected = false; // if(dropdownOptions.find("input.user-input:checked").length)
    ...
    function clearSelected() {
      ...
      updateLabelText(); // dropdownOptions.find("input.user-input").first().triggerHandler("change");
    ...
    function enable() {
      view.removeClass("disabled"); // view.find("input:not(.disabled-always)").prop("disabled", false);

      inputs.filter(":not(.disabled-always)").prop("disabled", false);
    }

    function disable() {
      view.addClass("disabled"); // view.find("input:not(.disabled-always)").prop("disabled", true);
  ...
  */
  ...
  $(document.body).on("view_loaded_site-modal", function (e, view) {
    ...
    const btModal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(modalElem.get(0));
    $(document.body).on("pboot_open_site_modal", function (e) {
      let _args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    $(document.body).on("pboot_open_site_modal_load", function (e) {
      let _args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      btModal.show(); // Load view in modal body
...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mods_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mods/index.js */ "./mods/index.js");
/* harmony import */ var _scss_front_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scss/front.scss */ "./src/scss/front.scss");
